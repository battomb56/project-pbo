<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bisa.aspx.cs" Inherits="bisa" %>
...
<head>
    ...
    <style>
        ...
        .parallax {
  /* The image used */
  background-image: url("IMAGE/home baru.png");
  text-align:center;
  color:aliceblue;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
            ...
            <div class="navbar-nav">
              ...
              <a class="nav-link" href="#">About Us</a><br />
                <div class="admin" style="float:right">
                    &nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Login Admin" />
                </div>
            </div>
              &nbsp;</div>
        </div>
      ...
      <div class="parallax">
        <div class="tulisan">
            ...
            <h2>Website untuk pengambilan nomer urut farm doc. dimana farm doc ini client dapat berkonsultasi ataupun meminta pengobatan untuk hewan ternak mereka, bisa memanggil untuk datang ketempat client ataupun client yang datang ketempat praktek.</h2>
             <h3>BUKA SENIN - JUMAT PUKUL 09.00 - 17.00</h3>
            <p>
                 &nbsp;</p>
        </div>  
          </div>
    ...
    <tr>  
        <td colspan="2">  
            <h1 class="auto-style3">Ambil Nomor Urut</h1>  
        </td>  
    </tr>  
    <tr>  
        <td>Nama_Pemilik</td>  
    ...
    <tr>  
        ...
        &nbsp;*berfungsi ketika anda akan mengupdate data</td>  
    </tr>  
    <tr>  
        <td colspan="2">  
    ...
    <script>
        var tombolTake Number = document.getElementsByClassName('tombol-Take Number')[0];
        var Take Number = document.getElementsByClassName('Take Number')[0];

        tombolTake Number.onclick = function () {
            Take Number.classList.toggle('active');
        }

        Take Number.onclick = function () {
            Take Number.classList.toggle('active');
        }
    </script>
